...
if is_flash_attn_2_available():
    try:
        ...
        _flash_bert_padding = importlib.import_module("flash_attn.bert_padding")
        index_first_axis = _flash_bert_padding.index_first_axis
        pad_input = _flash_bert_padding.pad_input
        unpad_input = _flash_bert_padding.unpad_input
    except Exception:
        # Keep eager attention path usable when flash-attn is not installed.
        pass
